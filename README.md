...
| **Menyer** | Upload the *Meny* and *Vinlista* as PDF (the dashed card first in the grid: click it or drop a PDF on it), preview them, choose which one the website links to, stop showing, delete. All uploads are kept until deleted. Only one per list is active. |
...
| **Användare** | Admins only. Add logins as *Personal* or *Admin*, change the role, delete *Personal*. You can't change or delete yourself. On phones it's behind your initial top right. |
